...
public class RichMenuController {
	...
	public RichMenuController(LineMessagingClient lineMessagingClient, LineBlobClient blobClient,
			LineplatformProperties lineplatformProperties) {
	...
	@PostMapping("addRich")
	public String addRichMenu(@RequestBody String lineUserId) {
		...
		try {
			...
			BotApiResponse resp3 = messagingClient
					.linkRichMenuIdToUser(lineUserId, resp1.getRichMenuId()).get();
