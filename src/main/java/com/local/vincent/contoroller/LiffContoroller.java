...
public class LiffContoroller {
	...
	@Autowired
	public LiffContoroller(UserDao userDao, UserMessageDao userMessageDao, MessageDao messageDao,
			PasswordDao passwordDao, PasswordService passwordService, MessageService messageService) {
	...
	public String insertMessage(@RequestParam("lineUserId") String lineUserId, @RequestParam("messageText") String messageText) {
		// パスワード作成
